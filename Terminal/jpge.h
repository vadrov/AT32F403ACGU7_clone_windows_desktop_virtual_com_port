...
namespace jpge
{
	...
	struct params
	{
		inline params() : m_quality(85), m_subsampling(H2V2), m_no_chroma_discrim_flag(false), m_two_pass_flag(false), m_use_std_tables(false), m_exchangeRB(false) { }
		...
		//Exchange of components R with B
		bool m_exchangeRB;
	};
